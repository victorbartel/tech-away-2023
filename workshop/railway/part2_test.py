...
from workshop.railway.part2_solved import do_it
...
def test_do_it_when_everything_works():
    # Arrange
    id_ = randint(1, 10)
    data = Box({"fields": {"mandatory1": id_, "mandatory2": str(uuid4())}})
    # Act
    actual = _SUT(data)
    # Assert
...
def test_do_it_when_mandatory1_is_missing():
    # Arrange
    id_ = randint(1, 10)
    data = Box({"fields": {"wrong": id_, "mandatory2": str(uuid4())}})
    # Act
    actual = _SUT(data)
    # Assert
...
def test_do_it_when_mandatory2_is_missing():
    # Arrange
    id_ = randint(1, 10)
    data = Box({"fields": {"mandatory1": id_, "wrong": str(uuid4())}})
    # Act
    actual = _SUT(data)
    # Assert
    assert_that(actual).is_equal_to(-1)
